<div class="flex align-items-center list-user-action">
    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Edit User" href="{{ route('usuarios.edit',$id) }}">
    ...
    <form action="{{route('usuarios.destroy',$id)}}" id="user-delete-{{$id}}" method="post">
        @method('delete')
        @csrf()
    </form>
    @endif
