                            ...
                            <div class="new-employee-info">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-select" data-trigger name="position" id="position">
                                            ...
                                            @foreach ($positionType as $type => $id)
                                                <option value="{{$id}}"  @if(old('position') == $id) selected @endif>{{$type}}</option>
                                            @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-mb-3">
                                        ...
                                        <label class="form-check-label" for="stay_on_this_page">Quedarse en esta misma pagina</label>
